...
def format2adjcencygraph(files, output, idmap, relabel=False, make_sym=False, pbg_idmap=""):
    file = files[0]
...
if __name__ == "__main__":
    ...
    print(args)
    format2adjcencygraph(args.file, args.output, args.idmap, relabel=args.relabel, make_sym=args.make_sym, pbg_idmap=args.pbg_idmap)
