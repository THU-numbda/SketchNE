...
struct gbbs_util{
  static void gbbs_sparse_mm(Graph& GA, mat<FP> *X, mat<FP> *Y,mat<FP> *degree_alpha);
  static void gbbs_sparse_mm_spectral(Graph& GA, mat<FP> *X, mat<FP> *Y,FP alpha,FP beta,mat<FP> *degree_array,FP mu);
};
...
struct util {
  ...
  static void linear_solve_Uxb(mat<T> *A, mat<T> *b);
